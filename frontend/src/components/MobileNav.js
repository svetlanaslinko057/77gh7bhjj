    ...
    groups: [
      {
        ...
        items: [
          ...
          { to: '/investor/marketplace',   icon: Repeat,   label: 'Вторинний ринок' },
          { to: '/investor/payments',      icon: Wallet,  label: 'Платежі' },
          { to: '/investor/wallet',        icon: PiggyBank, label: 'Гаманець' },
          { to: '/investor/income',        icon: TrendingUp, label: 'Доходи' },
          { to: '/investor/analytics',     icon: PieChart, label: 'Аналітика' },
        ],
      },
      {
        label: 'Аккаунт',
